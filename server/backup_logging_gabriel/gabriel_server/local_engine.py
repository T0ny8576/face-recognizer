...
class _LocalServer:
    ...
    async def _engine_comm(self):
        ...
        while self._server.is_running():
            ...
            logger.warning('Start,{},{},{}'.format(address, from_client.frame_id, int(time.time() * 1000.)))
            ...
            logger.warning('Finish,{},{},{}'.format(address, from_client.frame_id, int(time.time() * 1000.)))
